...
class _ApiService implements ApiService {
  ...
  Future<GetUserHistoryResponse> getUserHistory(
    GetUserHistoryBody userHistoryBody,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(userHistoryBody.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetUserHistoryResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GetUserHistoryResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<AppointmentHistoryResponse> getAppointmentHistory(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AppointmentHistoryResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AppointmentHistoryResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<AddHistoryResponse> addHistory(
    AddHistoryBody historyBody,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(historyBody.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AddHistoryResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AddHistoryResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<UserVisitsResponse> getUserVisits(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<UserVisitsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UserVisitsResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<GetPostsResponse> getPosts() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<GetPostsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GetPostsResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<dynamic> upVotePost(
    PostVotesBody voteBody,
    String token,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
